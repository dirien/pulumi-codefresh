...
func NewAccount(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("codefresh:index/account:Account", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccount(ctx *pulumi.Context,
	...
	var resource Account
	err := ctx.ReadResource("codefresh:index/account:Account", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type accountState struct {
	// A collection of `build` blocks as documented below.
	Builds []AccountBuild `pulumi:"builds"`
	// map of supported features toggles
	// ---
	Features map[string]bool `pulumi:"features"`
	// A collection of `limits` blocks as documented below.
	Limits []AccountLimit `pulumi:"limits"`
	// The display name for the account.
...
func (o AccountOutput) Builds() AccountBuildArrayOutput {
	return o.ApplyT(func(v *Account) AccountBuildArrayOutput { return v.Builds }).(AccountBuildArrayOutput)
}

// map of supported features toggles
// ---
func (o AccountOutput) Features() pulumi.BoolMapOutput {
	return o.ApplyT(func(v *Account) pulumi.BoolMapOutput { return v.Features }).(pulumi.BoolMapOutput)
}

// A collection of `limits` blocks as documented below.
func (o AccountOutput) Limits() AccountLimitArrayOutput {
	return o.ApplyT(func(v *Account) AccountLimitArrayOutput { return v.Limits }).(AccountLimitArrayOutput)
}
