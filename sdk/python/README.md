...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `codefresh` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-codefresh
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-codefresh/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-codefresh/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-codefresh_darwin_amd64_v1
│   └── pulumi-resource-codefresh
├── pulumi-codefresh_darwin_arm64
│   └── pulumi-resource-codefresh
├── pulumi-codefresh_linux_amd64_v1
│   └── pulumi-resource-codefresh
├── pulumi-codefresh_linux_arm64
│   └── pulumi-resource-codefresh
├── pulumi-codefresh_windows_amd64_v1
│   └── pulumi-resource-codefresh.exe
└── pulumi-codefresh_windows_arm64
    └── pulumi-resource-codefresh.exe
```
