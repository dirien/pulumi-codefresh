...
namespace Pulumiverse.Codefresh
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/dirien/pulumi-codefresh";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Codefresh.version.txt");
    ...
    internal sealed class CodefreshResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CodefreshResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
